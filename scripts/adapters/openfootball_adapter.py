"""
Orquestador ultra-blindado de demolición masiva.
Ignora carpetas dinámicas y corre el adaptador directo a fuego.
"""
...
class OpenFootballAdapter:
    def fetch_matches(self) -> List[Dict]:
        try:
            print(f"Fetching from OpenFootball DIRECT: {OPENFOOTBALL_URL}")
